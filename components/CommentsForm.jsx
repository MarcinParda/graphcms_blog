...
const CommentsForm = ({ slug }) => {
  ...
  return (
    <div className="bg-white dark:bg-black dark:bg-opacity-70 dark:text-gray-100 shadow-lg rounded-lg p-8 pb-12 mb-8 transition ease-in-out duration-300">
      ...
      <div className="mt-8">
        <button type="button" onClick={handlePostSubmission} className="transition duration-500 ease hover:bg-blue-600 dark:hover:bg-blue-500 inline-block bg-green-600 dark:bg-green-500 text-lg font-medium rounded-full text-white px-8 py-3 cursor-pointer transition ease-in-out duration-300">Post Comment</button>
      </div>
